...
<body style="background-image: url(WEB-INF/recourses/background-40.png);">
	...
	<div style="overflow:auto;">
		...
		<div class="main">
			<h2 style="text-align:center;">Course journal</h2>
				<p>
				There would be information about courses, students, teachers.
				<br>
				Maybe it will be possible to set search parameters
				<br>
				TABLE
				</p>
		</div>
