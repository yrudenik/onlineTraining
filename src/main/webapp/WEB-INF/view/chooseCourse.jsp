...
<body style="background-image: url(WEB-INF/recourses/background-40.png);">
	...
	<div style="overflow:auto;">
	    <div class="menu">
		    <div class="btn-group">
				<form action="Choose a course.html"><button class="button">Choose a course</button></form>
				<form action="Task information.html"><button class="button">Task information</button></form>
		    </div>
	    </div>

		<div class="main">
			<h2 style="text-align:center;">Choose a course</h2>
				<p>
				There would be information about upcoming available courses.
				<br>
